<img src="assets/docs/readme_hero.png" style="margin: 0;"> 
...
* **JS - JavaScripttechnology** – was used as the main language to create the interactive elements of the Website.
...
1. Background Slider code soultion on the landing page - inspiration and code snippet from [**50 Projects In 50 Days - HTML, CSS & JavaScript**](https://www.udemy.com/course/50-projects-50-days/)
 course created by Brad Traversy and Florin Pop 
1. Gallery form inspiration was borrowed from …....
2. Inspiration for map was borrowed from course content walkthrough Rosie
2. Inspiration for email was borrowed from course content walkthrough Rosie
