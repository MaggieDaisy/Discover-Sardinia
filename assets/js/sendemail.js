// Credit - code inspiration borrowed from Course Project Walkthrough about Rosie - Putting it all together, Sending Emails Using EmailJS

// Create function send email, add send method which contains three arguments
// (service ID, template ID, and an object with three parameters which matches template EmailJS)
function sendMail(responsiveForm) {
    emailjs
        ...
        // Add then method and insert two functions, first will return a response that sending email was a success, second instead shows an error
        .then(
            function (success) {
